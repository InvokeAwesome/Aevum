...
If you want to read ahead, there's a detailed outline in link:doc/notes.adoc#. I tried to hide spoilers if you want to read through it, but it is primarily my author's notes, so it's meant to be thorough rather than dramatic. There are also character, place, philosophy, and history notes in there. 
