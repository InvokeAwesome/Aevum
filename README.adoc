...
I have selected a Creative Commons license for this novel. You can read it in its entirety LICENSE.md#[here], but the gist is that anyone can copy and modify the text as much as they want, except they can't use it for commercial purposes without permission.
