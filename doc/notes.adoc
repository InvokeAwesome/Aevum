...
Read <<{mc_name} {mc_surname}, her character notes>> (but no further) to learn what we might want to convey in this first chapter.
...
1. He permits her drawn to {ow_name} (ultimately being the cause of so much chaos) because he actually wants to allow Satan's plan to succeed, nominally. {ow_name} has had too few trials, and has not fully learned the way of the cross.
****
+++ </div></details> +++
...
"Could this have just been an impressively well-engineered internet hoax?"
...
"Saying they do take me in, what then? They're running for their lives. If I get caught up in that, I could be imprisoned and tortured, or maybe even killed..."

This gives her pause. 

She clenches her teeth. Her hands shake badly. She has lost all focus on driving. 
