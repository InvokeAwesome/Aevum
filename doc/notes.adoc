...
NOTE: Could we perhaps start with the hiking incident, and then jump forward to a regular day? That might help color the day enough to bring out more of her character quirks, and also might be an opportunity for foreshadowing.
****
