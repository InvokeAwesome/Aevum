...
Sweaty and tired +
Carrying a fairly heavy pack for his size

==== Narratitve

The above characters are hiking together along the side of a river, heading down the mountain.  +

They take a break, because the {sib_gender} is tired. He sits on some wet moss and gets his tush dampened. His {mc_sibling_relationship} sees and makes fun of them, which starts an argument.   +

Mother meanwhile hangs up a gravity water filter and diffuses the situation.
...
They watch the filter process some water into their empty thermos jugs. +
...
The mother takes off her pack and heads down first. She lowers herself down to a narrow ledge about 4 feet down. Then, facing the slope, she picks her way back and forth along a path of sorts, which proves to be easily navigable with some patience. She reaches the bottom in less than 15 seconds +

She has the children lower down all of the packs to her. +
...
She is a decorated EMT with 15 years of professional first aid experience by the time {mc_name} is {mc_trauma-age}. +

She is married to <<{dad_heading}, {dad_name}:>>, and is the mother of <<{mc_heading}, {mc_name}:>> and <<{sib_heading}, {sib_name}:>>

==== Appearance

She is lithe and athletic even at  but plain.
