...
'''
_Style:_ Iambic hexameter couplets. Semi-elevated style. +

_Setting:_ A beautiful, wooded trail in the Appalachian Mountains. +
...
* Hair in a similar ponytail to her mother
* Wearing a print T-shirt from last year's summer camp, pink cargo shorts. Brand new shoes that are slightly too big.
...
* *MOTHER:* speaking to them in {mc_native-language}, she tells them to feel the water. 
...
* *MOTHER:* "See what we've been missing? Aren't you glad Dad finally let us come out here?"
* *CHILDREN:* Both respond with a loud "YEAH!" that echoes through the forest.
* *MOTHER:* "Maybe we can convince him to come with us next time. What do you think?"
* *{sib_line-u}:* Proceeds to optimistically describe the particular way in which their Dad would agree to do so.
...
* *CHILDREN:* They complain, protesting the danger. Their small voices are almost drowned out by the sound of the waterfall, and they must shout to be heard.
* The mother surveys the descent again, pointing out the steps they must take.
* *MOTHER:* Raising her voice, she encourages them: "I'm right here, guys! Even if you did fall, I'd catch you. But you won't fall, because you're really strong! {mc_name}, you can go first, to show your {mc_sibling} how it's done."
* *{mc_line}:*  Protests again
* *MOTHER:* "You can do this, {mc_name}! It's gonna be alright."
